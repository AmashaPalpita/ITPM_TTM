 ...
 * @author Dell
 */
public class manageLectureLocatNoAvi extends javax.swing.JFrame {
    ...
    /**
     * Creates new form manageLectureLocatNoAvi
     */
    public manageLectureLocatNoAvi() {
        initComponents();
    ...
    public void tableload(){
        ...
        String sql = "SELECT id, selectRoom, selectTime, selectDate, endTime FROM lecture_location";
        pst  = con.prepareStatement(sql);
        
        rs =  pst.executeQuery();
        
        tablelecture.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private void initComponents() {
        ...
        endtime.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Date", "1", "2", "3", "4", "5", "6", "7", "8", " " }));
        ...
        tablelecture.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Select Room", "Select Time", "Select Date", "End Time"
            }
        ));
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(selecttime, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(endtime, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(selectdate, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(349, 349, 349)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel6)
                            .addComponent(endtime, javax.swing.GroupLayout.PREFERRED_SIZE, 19, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
    ...
    private void tablelectureMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablelectureMouseClicked
        ...
        int r = tablelecture.getSelectedRow();
        
        String id = tablelecture.getValueAt(r, 0).toString();
        String selectRoom = tablelecture.getValueAt(r, 1).toString();
        String selectTime = tablelecture.getValueAt(r, 2).toString();
        String selectDate = tablelecture.getValueAt(r, 3).toString();
        String endTime = tablelecture.getValueAt(r, 4).toString();
        
        selectroom.setSelectedItem(selectRoom);
        selecttime.setSelectedItem(selectTime);
        
        selectdate.setText(selectDate);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (x == 0){
            ...
            String sql = "UPDATE lecture_location SET selectRoom = '"+ selectRoom +"', selectTime = '"+ selectTime +"', selectDate = '"+ selectDate +"', endTime = '"+ endTime +"'  where id = '"+ id +"'";
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if ( x == 0 ){
            ...
            String sql = "DELETE from lecture_location where id = '"+ id +"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(manageLectureLocatNoAvi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new manageLectureLocatNoAvi().setVisible(true);
            }
        });
    }
